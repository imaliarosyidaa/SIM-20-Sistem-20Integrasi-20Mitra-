...
// Mock data for activities (same as before)
const activities = [
  {
    id: 1,
...
export default function MatriksKegiatanCalendar() {
  const { month: paramMonth } = useParams();
  const navigate = useNavigate();
  
  // Default to current month if no param or July 2025 for demo
  const getInitialDate = () => {
    if (paramMonth) {
      const monthIndex = months.findIndex(m => m.toLowerCase().includes(paramMonth));
      if (monthIndex !== -1) {
        return new Date(2025, monthIndex, 1);
      }
    }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-2 text-sm text-gray-600">
        ...
        <span>/</span>
        <span className="text-gray-900 font-medium">Kalender {months[month]} {year}</span>
      </div>
        ...
        {showSidebar && (
          <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
            ...
            <div className="p-4 border-b">
              <button className="flex items-center px-4 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors mb-4 w-full">
          ...
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center space-x-4">
              ...
              <button 
                ...
                className="px-3 py-1 text-sm text-brand-600 border border-brand-600 rounded hover:bg-brand-50"
              >
                Hari Ini
              </button>
            </div>
