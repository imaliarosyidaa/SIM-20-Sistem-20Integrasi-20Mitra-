...
import { ArrowBigDown, ArrowDown, ChevronDownIcon, ChevronUpIcon } from 'lucide-react';
        ...
        <>
            <div className="flex justify-between items-start mb-4">
                ...
                <details className="dropdown">
                    <summary className="btn m-1 btn-success flex items-center gap-1">Download <ChevronDownIcon></ChevronDownIcon></summary>
                    <ul className="menu dropdown-content bg-base-100 rounded-box z-1 shadow-sm bg-white">
                        <li
                            className="dropdown-item cursor-pointer gap-1 p-2 hover:bg-gray-100">
                            <CSVLink
                                enclosingCharacter={""}
                        ...
                        <li className="dropdown-item cursor-pointer gap-1 p-2 hover:bg-gray-100">
                            <button className="dropdown-item cursor-pointer flex items-center gap-1" onClick={() => downloadExcel(data)} to={''}>
