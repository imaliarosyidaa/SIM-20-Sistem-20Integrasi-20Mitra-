        ...
        <>
            <div className="flex justify-between items-center mb-6 gap-4">
                ...
                <details className="dropdown">
                    <summary className="btn btn-sm bg-blue-600 hover:bg-blue-700 text-white border-none flex items-center gap-2 shadow-sm transition-all duration-200 font-semibold">
                    ...
                    <ul className="dropdown-content z-50 menu p-2 shadow-lg bg-white rounded-lg border border-gray-200">
                        ...
                        <li className="hover:bg-gray-50 rounded transition-colors duration-150">
                            <button className="flex items-center gap-2 text-gray-700" onClick={() => downloadExcel(data)}>
